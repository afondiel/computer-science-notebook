...
/* =================== PUBLIC FUNCTIONS // OPERATIONS of the class ======= */
void BCPeriodicPoller_Init(BCPeriodicPoller* const me) { 
	me->pollTime = DEFAULT_
...
void BCPeriodicPoller_addItsBreathingCircuitSensor(
													BCPeriodicPoller* const me, 
...
void BCPeriodicPoller_removeItsBreathingCircuitSensor( 
															BCPeriodicPoller* const me,
															struct BreathingCircuitSensor * p_BreathingCircuitSensor
													) 
{
